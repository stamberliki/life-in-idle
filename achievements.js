export class achievements{
	...
	constructor(game){
		...
		this.textDescriptionName = ['aaaaaa','bbbb','cccccc','ddddddd','eeeeeee','ffffffff','ggggggg','hhhhhhh','iiiiii','jjjjj'];
		this.textDescription = ['aaaaaa','bbbb','cccccc','ddddddd','eeeeeee','ffffffff','ggggggg','hhhhhhh','iiiiii','jjjjj'];
